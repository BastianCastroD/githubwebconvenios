      ...
      <Formik
        ...
        validate={(valores) => {
          ...
          if (!valores.correo) {
            ...
            errores.correo =
              "Introduzca una direccion válida de correo electrónico (Ex: johndoe@domain.com).";
          }
            ...
            {console.log(errors)}
              ...
              <div>
                ...
                <div className="recaptcha">
                  <ReCAPTCHA sitekey="6Lek9tsiAAAAAOUyn_NBrROccYIf_-w38fsocNlN" />
                </div>
                <div id="accionLogin">
                  <div id="botonLogin">
                    <button>
              ...
              <div>
                ...
                <div id="accionRegistro">
                  <div id="botonRegistro">
                    <button>
                      <NavLink className="navlink" to="/NuevoPacienteCliente">
                        Crea una cuenta
                      </NavLink>
                    </button>
                  </div>
